...
class AnalizerCoruna(Analizer): 
    ...
    def urlGenerator(self): 
        ...
        url = "https://bop.dacoruna.gal/bopportal/cambioBoletin.do?fechaInput=" + format(tempdate.day,'02') + "/" + format(tempdate.month, '02') + "/" + format(tempdate.year, '04')
        print(url)
        urls.append(url)
    ...
    def run(self): 
        print("Arrancando analizador de Coruña")
